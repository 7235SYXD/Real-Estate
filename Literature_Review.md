...
| Symbol | Meaning |
|--------|---------|
| 🏗️ | Used to justify a **model/architecture** choice |
| 📊 | Used to support **methodology** (cleaning, features, evaluation) |
| 📝 | Used to frame the **NLP / text mining** approach |
| 🔍 | Used to justify **interpretability** analysis |
| 📌 | Used for **background / motivation** of the project |
...
> 🏗️**How used:** It is consistent with the use of  ensemble learning method and inspires the
...
> 🏗️ **How used:**Technical documentation for CatBoost — one of the four base learners.
...
> 🏗️ **How used:** The empirical findings from 50 datasets demonstrate that CatBoost is 
...
> 🏗️ **How used:** Uses NNLS (Non-Negative Least Squares) as the meta-learner for stacking. 
...
> 🏗️ **Usage:** Used as the primary architectural reference for the whole stacking process.
